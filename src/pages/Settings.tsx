...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        console.log('Fetching user data in Settings...');
        const me = await api.me() as any;
        console.log('User data from API:', me);
        console.log('Current user data in context:', data.user);
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Total Income: ₹{data.income.reduce((sum, inc) => sum + inc.amount, 0).toLocaleString()}
              </p>
            </div>
